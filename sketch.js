...
var engine, world;
var box1, box2, box3, box4, box5, box6, box7, box8, box9, box10, box1;
...
function draw(){
  ...
  if(monster.body.position.y>600){
    var tposx= monster.body.position.x;
    var tposy= monster.body.position.y;

    fill("black");
    textSize(50);
    text("NOOOOO!!",tposx-150, tposy-230);
  }
}
